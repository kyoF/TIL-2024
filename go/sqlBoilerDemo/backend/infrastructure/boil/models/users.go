...
var (
	userAllColumns            = []string{"id", "user_id", "name", "email", "profile", "password", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"user_id", "name", "email", "profile", "password"}
...
func (o *User) Likes(mods ...qm.QueryMod) likeQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`likes`.`user_id`=?", o.UserID),
	)
...
func (o *User) Tweets(mods ...qm.QueryMod) tweetQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`tweets`.`user_id`=?", o.UserID),
	)
